...
$wrapper_attributes[] = 'class="' . esc_attr( trim( $css_class ) ) . ' '.$type.' '.$vertical_padding.' '.$pullup.'"';

$style_attributes = '';
if($zindex!=''){ $style_attributes .= ' z-index:'.$zindex; }

$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ($style_attributes!=''?' style="'.$style_attributes.'"':'').'>';
