...
{  
     ...
     if(1 != $pages)
     {
         ...
         echo '<div class="pagination_wrapper"><div class="pagination-centered"><ul class="pagination">';
         ...
         if($paged > 1) echo "<li class='arrow'><a href='".get_pagenum_link($paged - 1)."'>&lsaquo;</a></li>";
